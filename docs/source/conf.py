...
# -*- coding: utf-8 -*-
#
# widget_message_speed documentation build configuration file
#
...
_version_py = os.path.join(repo, 'widget_message_speed', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'widget_message_speeddoc'
...
latex_documents = [
    (master_doc, 'widget_message_speed.tex', 'widget_message_speed Documentation',
     'ian', 'manual'),
]
...
man_pages = [
    ...
    'widget_message_speed Documentation',
     [author], 1)
]
